        ...
        <div class="w-container pt-16 mb-16 h-auto m-auto">
            <div class="p-4 flex justify-between items-center">
                ...
                <div class="h-auto w-auto p-4 flex justify-center items-center">
                    ...
                    <div class="w-auto h-full rounded-3xl border-[1px] hover:bg-blue-500 hover:text-white border-black hover:border-white p-2 cursor-pointer  mr-4"
                        :class="{ 'invisible': selectedTracks.length === 0 || selectedTracks.length > 1 }">
                        Edit Tracks
                    </div>
                </div>
            </div>
            <div class="w-full">
                <table class="w-full">
                    <thead>
                        <tr>
                            <th class="w-[5%] m-auto"> <input type="checkbox" name="" id="allCheckbox" v-model="allSelected" @change="toggleAllTracks"> </th>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in songs" :key="index" class="hover:bg-gray-200 cursor-pointer">
                            ...
                            <th class="text-left text-sm"
                                :class="{ 'text-red-500': item.isPublic === false, 'text-blue-400': item.isPublic === true }">
                                {{ item.isPublic ? 'Public' : 'Private' }}</th>
                        </tr>
                    </tbody>
                </table>
            </div>
